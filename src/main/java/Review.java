...
public class Review {
  ...
  public Review (String userName, String userReview, Integer rating){
...
public static List<Review> all(){
  ...
  public void save(){
    String sql = "INSERT INTO reviews (username,userReview,rating, movieId) VALUES (:name,:userReview,:rating,:movieId)";
    try(Connection con = DB.sql2o.open()){
      this.id = (int) con.createQuery(sql,true)
      .addParameter("username",this.userName)
      .addParameter("userReview",this.userReview)
      .addParameter("rating",this.rating)
      .addParameter("movieId",this.movieId).executeUpdate().getKey();
    }
  }
